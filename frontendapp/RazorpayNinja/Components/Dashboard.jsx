...
export default function Dashboard(props){
    ...
    return(
        ...
        <SafeAreaView style={classes.container}>
            <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 1}} colors={['#020024', '#102461', '#2649b6']} style={classes.section1}>
                <Text style={{
                    color : 'white',
                    fontSize : 30,
                    paddingLeft : 20,
...
const pageInfo = [
    {
        icon : <Ionicons name="cart-outline" style={classes.icon}></Ionicons>,
    ...
    {
        icon : <Ionicons name="cash-outline" style={classes.icon}></Ionicons>,
